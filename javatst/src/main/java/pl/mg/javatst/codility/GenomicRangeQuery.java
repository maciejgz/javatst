 ...
 * arrays P and Q, each consisting of M integers. The K-th
 * query (0 ≤ K < M) requires you to find the minimal impact
 * factor of nucleotides contained in the DNA sequence between
 ...
 * nucleotides G and C (twice), whose impact factors are
 * 3 and 2 respectively, so the answer is 2.
 * The part between positions 5 and 5 contains a single
 * nucleotide T, whose impact factor is 4, so the answer is 4.
 * The part between positions 0 and 6 (the whole string)
 * contains all nucleotides, in particular nucleotide A whose
 * impact factor is 1, so the answer is 1.
 * Write a function:
 * <p>
 * class Solution { public int[] solution(String S, int[] P, int[] Q); }
 * <p>
 * that, given a non-empty zero-indexed string S consisting
 * of N characters and two non-empty zero-indexed arrays P and
 * Q consisting of M integers, returns an array consisting of M
...
public class GenomicRangeQuery {
    ...
    public int[] solution(String S, int[] P, int[] Q) {
      return solveGenomicRange(S, P, Q);
    }
