 ...
 * Then only one fish can stay alive − the larger fish eats the smaller one. More precisely, we say that
 ...
 * number 2 and eats it, then it meets fish number 3 and eats it too. Finally, it meets fish number 4 and is eaten by it.
