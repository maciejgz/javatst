...
public class Day15RobotMovements {

    protected Day15RobotMovements() {
    }

    public static void main(String[] args) {
        Day15RobotMovements solution = new Day15RobotMovements();
        System.out.println(solution.runPart1(Utils.readLines("src/main/resources/adventofcode/day15_input.txt")));
